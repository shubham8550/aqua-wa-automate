...
const {helpContent} = require("./features/helpContent");
const {redditContent} = require("./features/redditContent");
const {addCandidate} = require("./features/addCandidate");
const {adminPollReset} = require("./features/adminPollReset");
const {voteAdapter} = require("./features/voteAdapter");
const {getPoll} = require("./features/getPoll");
const {sourceAdapter} = require("./features/sourceAdapter");
const {mangaSearch} = require("./features/mangaSearch");
const {animeSearch} = require("./features/animeSearch");
